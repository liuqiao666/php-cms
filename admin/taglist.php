        ...
        <div class="page-wrapper">
            <div class="row page-titles m-b-0">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">标签管理</h3>
                </div>
										...
										?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="edittag.php?content=<?php echo $row['content'];?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                                    <a href="shantag.php?content=<?php echo $row['content'];?>" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        </tbody>
