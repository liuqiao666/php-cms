<?php 
	...
	$mailbody="Hi ".$mailto." This is a test email from 内容管理系统    密码找回：http://localhost/cms/admin/recover-password.php?email=".$mailto;  
	...
	fwrite($fp,"DATA".$CRLF); 
	$temp= fgets($fp,512);  
	$subject="Subject:来自内容管理系统的验证邮件，请及时查收，谢谢！".$CRLF;   
